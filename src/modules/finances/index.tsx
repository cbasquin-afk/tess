    ...
    <FinancesProvider>
      ...
      >
        <Routes>
          ...
          {/* Legacy : le Simulateur a été extrait en module autonome
              /simulateur (accessible aux commerciaux). Redirection douce
              pour préserver les bookmarks. */}
          <Route path="simulateur" element={<Navigate to="/simulateur" replace />} />
